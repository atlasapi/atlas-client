...
public class ItemTestDataBuilder {
    ...
    private SourceDetails publisher;
    ...
    private SourceDetails defaultPublisher() {
        SourceDetails publisher = new SourceDetails("http://test.metabroadcast.com/publishers/default");
    ...
    public ItemTestDataBuilder withPublisher(SourceDetails publisher) {
